...
public class UserInfoDAO {
    ...
    public ArrayList<UserInfo> QueryUserInfoInfo(String user_name,Area areaObj,String name,String birthDate,String telephone,int currentPage) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From UserInfo userInfo where 1=1";
    	if(!user_name.equals("")) hql = hql + " and userInfo.user_name like '%" + user_name + "%'";
    	if(null != areaObj && areaObj.getAreaId()!=0) hql += " and userInfo.areaObj.areaId=" + areaObj.getAreaId();
    ...
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public ArrayList<UserInfo> QueryUserInfoInfo(String user_name,Area areaObj,String name,String birthDate,String telephone) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From UserInfo userInfo where 1=1";
    	if(!user_name.equals("")) hql = hql + " and userInfo.user_name like '%" + user_name + "%'";
    	if(null != areaObj && areaObj.getAreaId()!=0) hql += " and userInfo.areaObj.areaId=" + areaObj.getAreaId();
    ...
    /*计算总的页数和记录数*/
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public void CalculateTotalPageAndRecordNumber(String user_name,Area areaObj,String name,String birthDate,String telephone) {
        Session s = factory.getCurrentSession();
        String hql = "From UserInfo userInfo where 1=1";
        if(!user_name.equals("")) hql = hql + " and userInfo.user_name like '%" + user_name + "%'";
        if(null != areaObj && areaObj.getAreaId()!=0) hql += " and userInfo.areaObj.areaId=" + areaObj.getAreaId();
